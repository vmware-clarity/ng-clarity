...
export class StepperStoryStep1 implements StepModelHolder {
  model: Step1Model;
}
...
export class StepperStoryStep2 implements StepModelHolder {
  model: Step2Model;
}
...
export class StepperStoryWrapperComponent implements OnInit {
