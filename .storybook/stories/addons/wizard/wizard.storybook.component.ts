...
export class WizardStoryStep1 implements StepModelHolder {
  model: Step1Model;
}
...
export class WizardStoryStep2 implements StepModelHolder {
  model: Step2Model;
}
...
export class WizardStoryWrapperComponent implements OnInit {
  label = 'Open Wizard';
