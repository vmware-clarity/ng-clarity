      ...
      <clr-dg-footer>
        <clr-dropdown>
          ...
          <clr-dropdown-menu *clrIfOpen [clrPosition]="'top-right'">
            <div (click)="datagrid.virtualScroll.scrollToIndex(20, 'smooth')" clrDropdownItem>20</div>
            <div (click)="datagrid.virtualScroll.scrollToIndex(60, 'smooth')" clrDropdownItem>60</div>
            <div (click)="datagrid.virtualScroll.scrollToIndex(80, 'smooth')" clrDropdownItem>80</div>
            <div (click)="datagrid.virtualScroll.scrollToIndex(100, 'smooth')" clrDropdownItem>100</div>
          </clr-dropdown-menu>
        </clr-dropdown>
      </clr-dg-footer>
    </clr-datagrid>
