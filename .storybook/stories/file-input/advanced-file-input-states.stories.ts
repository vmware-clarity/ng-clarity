...
<clr-file-input-container>
  ...
  <clr-file-list>
    <ng-template clr-file-messages let-file let-errors="errors">
      ...
      @if (errors.accept) { <clr-file-error>File type not accepted</clr-file-error> }
      @if (errors.minFileSize) { <clr-file-error>File size too small</clr-file-error> }
      @if (errors.maxFileSize) { <clr-file-error>File size too large</clr-file-error> }
    </ng-template>
  </clr-file-list>
</clr-file-input-container>
`;
