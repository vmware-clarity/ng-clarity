...
import { LayoutTestComponent } from './paddings.storybook.component';

/**
 * The story renders `<layout-test-component>` through `component:`. The component takes no
 * `@Input()`s -- the padding scale is spelled out in its template -- so the args are empty.
 */
...
type Story = StoryObj<PaddingsArgs>;
