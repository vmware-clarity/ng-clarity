...
module.exports = [
  ...
  globalIgnores([
    ...
    'documentation.json',
    // Generated by a local `playwright test` run. Git-ignored, but flat config lints it anyway,
    // so without this `npm run lint` fails for anyone who has run the visual tests.
    'playwright-report',
    'test-results',
  ]),
];
