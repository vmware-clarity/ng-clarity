...
class EnumPropertyDefinition extends FilterablePropertyDefinition {
     ...
     */
    constructor(displayName, property, values, singleSelect = false, searchable = false, showKeyInParentheses = false, allowNotInOperator = false) {
        super(displayName, property, allowNotInOperator ? [ComparisonOperator.Equals, ComparisonOperator.DoesNotEqual] : undefined);
        /**
         ...
         */
        this.showKeyInParentheses = false;
        this.values = values;
...
class EnumFilterComponent {
    ...
    constructor(formBuilder, filterStrings, cdr) {
        ...
        this.enumOperators = [ComparisonOperator.Equals, ComparisonOperator.DoesNotEqual];
    ...
    updateData() {
        ...
        this.enumFilterForm?.controls.enumOperator.setValue(this.propertyFilter?.operator === LogicalOperator.And
            ? ComparisonOperator.DoesNotEqual
            : ComparisonOperator.Equals);
    }
    updateForm() {
...
class UsersFilterComponent {
    ...
    constructor(fb, cdr, filterStrings, userService) {
        ...
        this.filterCriteriaChange = new EventEmitter();
        this.userOperators = [ComparisonOperator.Equals, ComparisonOperator.DoesNotEqual];
