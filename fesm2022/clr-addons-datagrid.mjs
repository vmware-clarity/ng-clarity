...
class ColumnOrderDirective {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.22", ngImport: i0, type: ColumnOrderDirective, deps: [{ token: i9.ClrDatagrid }, { token: i0.ElementRef }, { token: DatagridColumnsOrderService }, { token: i0.ChangeDetectorRef }, { token: i6.CdkDrag }], target: i0.ɵɵFactoryTarget.Directive }); }
    static { this.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "21.2.22", type: ColumnOrderDirective, isStandalone: false, selector: "clr-dg-column[appfxColumnOrder]", inputs: { columnData: "columnData", columnIndex: "columnIndex" }, host: { listeners: { "keydown": "keydown($event)" }, properties: { "class.grabbed": "this.isGrabbed" } }, ngImport: i0 }); }
}
...
class DatagridFilterComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.22", ngImport: i0, type: DatagridFilterComponent, deps: [{ token: DatagridStrings }, { token: i2$1.ClrPopoverService }], target: i0.ɵɵFactoryTarget.Component }); }
...
class DatagridFilterContainerComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.22", ngImport: i0, type: DatagridFilterContainerComponent, deps: [{ token: i9.ClrDatagridFilter }], target: i0.ɵɵFactoryTarget.Component }); }
...
class DatagridColumnsOrderModule {
    ...
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.2.22", ngImport: i0, type: DatagridColumnsOrderModule, declarations: [ColumnOrderDirective, DatagridColumnsOrderDirective], imports: [ClrDatagridModule, CommonModule, DragDropModule], exports: [ColumnOrderDirective, DatagridColumnsOrderDirective] }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.2.22", ngImport: i0, type: DatagridColumnsOrderModule, imports: [ClrDatagridModule, CommonModule, DragDropModule] }); }
}
