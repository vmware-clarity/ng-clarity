...
import { EventEmitter, ElementRef, Output, Input, ViewChildren, Component, Injectable, InjectionToken, Optional, Inject, Host, Directive, HostListener, HostBinding, ViewChild, ViewContainerRef, Pipe, forwardRef, ChangeDetectionStrategy, NgModule, SkipSelf } from '@angular/core';
...
import { ClarityIcons, angleIcon, banIcon, dragHandleIcon, plusIcon, ClrIcon } from '@clr/angular/icon';
...
import * as i5$1 from '@clr/addons/datagrid-filters';
...
import * as i5 from '@clr/angular/utils/loading';
...
class CsvHelperService {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: CsvHelperService, deps: [], target: i0.ɵɵFactoryTarget.Injectable }); }
    static { this.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: CsvHelperService }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: CsvHelperService, decorators: [{
            type: Injectable
        }] });
...
class DatagridStrings {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: DatagridStrings, deps: [], target: i0.ɵɵFactoryTarget.Injectable }); }
    static { this.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: DatagridStrings }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: DatagridStrings, decorators: [{
            type: Injectable
        }] });
...
class ExportProviderService {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: ExportProviderService, deps: [{ token: CsvHelperService }, { token: i0.Renderer2 }, { token: i0.ElementRef }, { token: DatagridStrings }, { token: appfxDatagridErrorNotifiableToken, optional: true }], target: i0.ɵɵFactoryTarget.Injectable }); }
    static { this.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: ExportProviderService }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: ExportProviderService, decorators: [{
            type: Injectable
...
class DatagridPreserveSelectionDirective {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: DatagridPreserveSelectionDirective, deps: [{ token: appfxPreselectableComponentToken, host: true }], target: i0.ɵɵFactoryTarget.Directive }); }
    static { this.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "21.2.23", type: DatagridPreserveSelectionDirective, isStandalone: false, selector: "[appfxPreserveSelection]", inputs: { preserveExistingSelection: "preserveExistingSelection" }, outputs: { selectedItemsUpdated: "selectedItemsUpdated" }, ngImport: i0 }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: DatagridPreserveSelectionDirective, decorators: [{
            type: Directive,
            args: [{
...
class DatagridColumnsOrderService {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: DatagridColumnsOrderService, deps: [], target: i0.ɵɵFactoryTarget.Injectable }); }
    static { this.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: DatagridColumnsOrderService }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: DatagridColumnsOrderService, decorators: [{
            type: Injectable
        }] });
...
class ColumnOrderDirective {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: ColumnOrderDirective, deps: [{ token: i9.ClrDatagrid }, { token: i0.ElementRef }, { token: DatagridColumnsOrderService }, { token: i0.ChangeDetectorRef }, { token: i6.CdkDrag }], target: i0.ɵɵFactoryTarget.Directive }); }
    static { this.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "21.2.23", type: ColumnOrderDirective, isStandalone: false, selector: "clr-dg-column[appfxColumnOrder]", inputs: { columnData: "columnData", columnIndex: "columnIndex" }, host: { listeners: { "keydown": "keydown($event)" }, properties: { "class.grabbed": "this.isGrabbed" } }, ngImport: i0 }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: ColumnOrderDirective, decorators: [{
            type: Directive,
            args: [{
...
class DatagridColumnsOrderDirective {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: DatagridColumnsOrderDirective, deps: [{ token: i0.ElementRef }, { token: i6.CdkDropList }, { token: DatagridColumnsOrderService }], target: i0.ɵɵFactoryTarget.Directive }); }
    static { this.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "21.2.23", type: DatagridColumnsOrderDirective, isStandalone: false, selector: "clr-datagrid[appfxDgColumnsOrder]", inputs: { dgColumnsOrderColumns: "dgColumnsOrderColumns", dgColumnsVirtualScrolling: "dgColumnsVirtualScrolling" }, outputs: { dgColumnsOrderChange: "dgColumnsOrderChange" }, providers: [DatagridColumnsOrderService], usesOnChanges: true, ngImport: i0 }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: DatagridColumnsOrderDirective, decorators: [{
            type: Directive,
            args: [{
...
class DatagridFilterComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: DatagridFilterComponent, deps: [{ token: DatagridStrings }, { token: i2$1.ClrPopoverService }], target: i0.ɵɵFactoryTarget.Component }); }
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "21.2.23", type: DatagridFilterComponent, isStandalone: false, selector: "appfx-datagrid-filter", inputs: { filterValue: "filterValue", stringFilterType: "stringFilterType", fieldName: "fieldName" }, outputs: { filterValueChange: "filterValueChange" }, viewQueries: [{ propertyName: "input", first: true, predicate: ["input"], descendants: true }], ngImport: i0, template: `
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: DatagridFilterComponent, decorators: [{
            type: Component,
            args: [{
...
class DatagridCellContainerComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: DatagridCellContainerComponent, deps: [], target: i0.ɵɵFactoryTarget.Component }); }
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "21.2.23", type: DatagridCellContainerComponent, isStandalone: false, selector: "appfx-dg-cell-container", inputs: { column: "column", item: "item" }, viewQueries: [{ propertyName: "container", first: true, predicate: ["cellContainer"], descendants: true, read: ViewContainerRef, static: true }], usesOnChanges: true, ngImport: i0, template: `
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: DatagridCellContainerComponent, decorators: [{
            type: Component,
...
class DatagridFilterContainerComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: DatagridFilterContainerComponent, deps: [{ token: i9.ClrDatagridFilter }], target: i0.ɵɵFactoryTarget.Component }); }
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "21.2.23", type: DatagridFilterContainerComponent, isStandalone: false, selector: "appfx-dg-filter-container", inputs: { filterType: "filterType", filterValue: "filterValue" }, outputs: { filterValueChange: "filterValueChange" }, viewQueries: [{ propertyName: "container", first: true, predicate: ["filterContainer"], descendants: true, read: ViewContainerRef, static: true }], ngImport: i0, template: ` <ng-template #filterContainer></ng-template>`, isInline: true, preserveWhitespaces: true }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: DatagridFilterContainerComponent, decorators: [{
            type: Component,
            args: [{
...
class IsRowSelectablePipe {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: IsRowSelectablePipe, deps: [], target: i0.ɵɵFactoryTarget.Pipe }); }
    static { this.ɵpipe = i0.ɵɵngDeclarePipe({ minVersion: "14.0.0", version: "21.2.23", ngImport: i0, type: IsRowSelectablePipe, isStandalone: false, name: "isRowSelectable" }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: IsRowSelectablePipe, decorators: [{
            type: Pipe,
...
class DatagridPageDirective {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: DatagridPageDirective, deps: [{ token: DatagridComponent, host: true }], target: i0.ɵɵFactoryTarget.Directive }); }
    static { this.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "21.2.23", type: DatagridPageDirective, isStandalone: false, selector: "[datagridPage]", inputs: { datagridPage: "datagridPage" }, outputs: { datagridPageChange: "datagridPageChange" }, ngImport: i0 }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: DatagridPageDirective, decorators: [{
            type: Directive,
            args: [{
...
class DatagridPersistSettingsDirective {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: DatagridPersistSettingsDirective, deps: [{ token: DatagridComponent, host: true }, { token: appfxDatagridPersistSettingsToken, optional: true }], target: i0.ɵɵFactoryTarget.Directive }); }
    static { this.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "21.2.23", type: DatagridPersistSettingsDirective, isStandalone: false, selector: "appfx-datagrid[appfxPersistDatagridSettings]", inputs: { appfxPersistDatagridSettings: "appfxPersistDatagridSettings", persistPageSize: "persistPageSize", persistSortOrder: "persistSortOrder" }, ngImport: i0 }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: DatagridPersistSettingsDirective, decorators: [{
            type: Directive,
            args: [{
...
class DatagridContentNoWrapDirective {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: DatagridContentNoWrapDirective, deps: [{ token: DatagridComponent, host: true }, { token: appfxDatagridUserPreferencesToken, optional: true }], target: i0.ɵɵFactoryTarget.Directive }); }
    static { this.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "21.2.23", type: DatagridContentNoWrapDirective, isStandalone: false, selector: "appfx-datagrid", ngImport: i0 }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: DatagridContentNoWrapDirective, decorators: [{
            type: Directive,
            args: [{
...
class DatagridColumnsOrderModule {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: DatagridColumnsOrderModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule }); }
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.2.23", ngImport: i0, type: DatagridColumnsOrderModule, declarations: [ColumnOrderDirective, DatagridColumnsOrderDirective], imports: [ClrDatagridModule, CommonModule, DragDropModule], exports: [ColumnOrderDirective, DatagridColumnsOrderDirective] }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: DatagridColumnsOrderModule, imports: [ClrDatagridModule, CommonModule, DragDropModule] }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: DatagridColumnsOrderModule, decorators: [{
            type: NgModule,
            args: [{
...
class AppfxDatagridModule {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: AppfxDatagridModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule }); }
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.2.23", ngImport: i0, type: AppfxDatagridModule, declarations: [DatagridComponent, DatagridActionBarComponent, DatagridFilterComponent, DatagridPageDirective,
            DatagridPersistSettingsDirective,
            DatagridPreserveSelectionDirective,
            ...
            DatagridPreserveSelectionDirective,
            DatagridContentNoWrapDirective] }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: AppfxDatagridModule, providers: [
            CsvHelperService,
            ExportProviderService,
            {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: AppfxDatagridModule, decorators: [{
            type: NgModule,
            args: [{
                    declarations: [
                        ...exportedComponents,
...
class DatagridFeatureStates {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: DatagridFeatureStates, deps: [], target: i0.ɵɵFactoryTarget.Injectable }); }
    static { this.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: DatagridFeatureStates }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: DatagridFeatureStates, decorators: [{
            type: Injectable
        }] });
