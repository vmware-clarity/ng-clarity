...
class FocusableDropdownItemDirective {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: FocusableDropdownItemDirective, deps: [{ token: i2.ClrDropdownItem }], target: i0.ɵɵFactoryTarget.Directive }); }
    static { this.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "21.2.23", type: FocusableDropdownItemDirective, isStandalone: false, selector: "[clrDropdownItem][appfxFocusableDropdownItem]", providers: [{ provide: FocusableItemProvider, useExisting: FocusableDropdownItemDirective }], ngImport: i0 }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: FocusableDropdownItemDirective, decorators: [{
            type: Directive,
            args: [{
...
class FocusableItemCollectorComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: FocusableItemCollectorComponent, deps: [], target: i0.ɵɵFactoryTarget.Component }); }
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "21.2.23", type: FocusableItemCollectorComponent, isStandalone: false, selector: "focusable-item-collector", inputs: { parentMenu: "parentMenu" }, queries: [{ propertyName: "items", predicate: FocusableItemProvider, descendants: true }], ngImport: i0, template: '<ng-content></ng-content>', isInline: true, preserveWhitespaces: true }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: FocusableItemCollectorComponent, decorators: [{
            type: Component,
            args: [{
...
class FocusableMenuDirective {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: FocusableMenuDirective, deps: [], target: i0.ɵɵFactoryTarget.Directive }); }
    static { this.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "21.2.23", type: FocusableMenuDirective, isStandalone: false, selector: "clr-dropdown-menu[appfxFocusableMenu]", providers: [{ provide: FocusableItemProvider, useExisting: FocusableMenuDirective }], ngImport: i0 }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: FocusableMenuDirective, decorators: [{
            type: Directive,
            args: [{
...
class MenuOutletService {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: MenuOutletService, deps: [], target: i0.ɵɵFactoryTarget.Injectable }); }
    static { this.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: MenuOutletService, providedIn: 'root' }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: MenuOutletService, decorators: [{
            type: Injectable,
...
class MenuOutletComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: MenuOutletComponent, deps: [{ token: MenuOutletService }], target: i0.ɵɵFactoryTarget.Component }); }
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "21.2.23", type: MenuOutletComponent, isStandalone: false, selector: "menu-outlet", viewQueries: [{ propertyName: "vc", first: true, predicate: ["vc"], descendants: true, read: ViewContainerRef }], ngImport: i0, template: ` <ng-container #vc></ng-container>`, isInline: true, preserveWhitespaces: true }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: MenuOutletComponent, decorators: [{
            type: Component,
            args: [{
...
class MenuActionComponent extends MenuItem {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: MenuActionComponent, deps: null, target: i0.ɵɵFactoryTarget.Component }); }
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "21.2.23", type: MenuActionComponent, isStandalone: false, selector: "appfx-menu-action", inputs: { iconClass: "iconClass", text: "text", shortcut: "shortcut", enabled: "enabled" }, outputs: { handle: "handle" }, providers: [
            {
                provide: MenuItem,
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: MenuActionComponent, decorators: [{
            type: Component,
            args: [{
...
class MenuHeaderComponent extends MenuItem {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: MenuHeaderComponent, deps: null, target: i0.ɵɵFactoryTarget.Component }); }
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "21.2.23", type: MenuHeaderComponent, isStandalone: false, selector: "appfx-menu-header", inputs: { iconClass: "iconClass", text: "text" }, providers: [
            {
                provide: MenuItem,
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: MenuHeaderComponent, decorators: [{
            type: Component,
            args: [{
...
class MenuSeparatorComponent extends MenuItem {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: MenuSeparatorComponent, deps: null, target: i0.ɵɵFactoryTarget.Component }); }
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "21.2.23", type: MenuSeparatorComponent, isStandalone: false, selector: "appfx-menu-separator", providers: [
            {
                provide: MenuItem,
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: MenuSeparatorComponent, decorators: [{
            type: Component,
            args: [{
...
class AppfxMenuModule {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: AppfxMenuModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule }); }
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.2.23", ngImport: i0, type: AppfxMenuModule, declarations: [FocusableDropdownItemDirective,
    ...
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: AppfxMenuModule, providers: [
            // Enable 200% and 400% zoom support
            ZoomLevelService,
        ], imports: [ClrDropdownModule, CommonModule] }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: AppfxMenuModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [ClrDropdownModule, CommonModule],
                    declarations: [
