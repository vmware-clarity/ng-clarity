...
class IfTabActiveDirective {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: IfTabActiveDirective, deps: [{ token: i4.ClrTab, host: true, self: true }, { token: i0.Renderer2 }], target: i0.ɵɵFactoryTarget.Directive }); }
    static { this.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "21.2.23", type: IfTabActiveDirective, isStandalone: false, selector: "[appfxIfTabActive]", inputs: { activeClass: "activeClass", activateTab: "activateTab" }, outputs: { appfxIfTabActiveChange: "appfxIfTabActiveChange" }, ngImport: i0 }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: IfTabActiveDirective, decorators: [{
            type: Directive,
            args: [{
...
class RenderAsButtonDirective {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: RenderAsButtonDirective, deps: [{ token: i4.ClrTabLink, host: true }, { token: i0.Renderer2 }, { token: i0.ElementRef }], target: i0.ɵɵFactoryTarget.Directive }); }
    static { this.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "21.2.23", type: RenderAsButtonDirective, isStandalone: false, selector: "[renderAsButton]", inputs: { renderAsButton: "renderAsButton" }, usesOnChanges: true, ngImport: i0 }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: RenderAsButtonDirective, decorators: [{
            type: Directive,
            args: [{
...
class AppfxTabsModule {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: AppfxTabsModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule }); }
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.2.23", ngImport: i0, type: AppfxTabsModule, declarations: [TabsComponent, TabLinksComponent, IfTabActiveDirective, RenderAsButtonDirective], imports: [AppfxWorkflowCoreModule, A11yModule, ClrTabsModule, ClrIcon, CommonModule, FormsModule, ReactiveFormsModule], exports: [TabsComponent, TabLinksComponent, IfTabActiveDirective] }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: AppfxTabsModule, imports: [appfxDependencies, clarityDependencies, CommonModule, FormsModule, ReactiveFormsModule] }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: AppfxTabsModule, decorators: [{
            type: NgModule,
            args: [{
