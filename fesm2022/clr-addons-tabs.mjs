...
class IfTabActiveDirective {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.22", ngImport: i0, type: IfTabActiveDirective, deps: [{ token: i4.ClrTab, host: true, self: true }, { token: i0.Renderer2 }], target: i0.ɵɵFactoryTarget.Directive }); }
...
class RenderAsButtonDirective {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.22", ngImport: i0, type: RenderAsButtonDirective, deps: [{ token: i4.ClrTabLink, host: true }, { token: i0.Renderer2 }, { token: i0.ElementRef }], target: i0.ɵɵFactoryTarget.Directive }); }
...
class AppfxTabsModule {
    ...
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.2.22", ngImport: i0, type: AppfxTabsModule, declarations: [TabsComponent, TabLinksComponent, IfTabActiveDirective, RenderAsButtonDirective], imports: [AppfxWorkflowCoreModule, A11yModule, ClrTabsModule, ClrIcon, CommonModule, FormsModule, ReactiveFormsModule], exports: [TabsComponent, TabLinksComponent, IfTabActiveDirective] }); }
