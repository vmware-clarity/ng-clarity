...
class ValidationBannerInternalComponent {
    ...
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "21.2.22", type: ValidationBannerInternalComponent, isStandalone: false, selector: "appfx-validation-banner-internal", inputs: { type: "type", closable: "closable", closed: "closed", items: "items" }, ngImport: i0, template: ` <clr-alert
    role="alert"
    aria-live="polite"
    [clrAlertType]="type"
    *ngIf="items?.length"
