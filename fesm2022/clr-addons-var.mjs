...
class WorkflowConfigurationService {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: WorkflowConfigurationService, deps: [], target: i0.ɵɵFactoryTarget.Injectable }); }
    static { this.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: WorkflowConfigurationService }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: WorkflowConfigurationService, decorators: [{
            type: Injectable
        }], ctorParameters: () => [] });
...
class WorkflowModelManager {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: WorkflowModelManager, deps: [], target: i0.ɵɵFactoryTarget.Injectable }); }
    static { this.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: WorkflowModelManager }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: WorkflowModelManager, decorators: [{
            type: Injectable
        }] });
...
class ValidationBannerInternalComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: ValidationBannerInternalComponent, deps: [], target: i0.ɵɵFactoryTarget.Component }); }
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "21.2.23", type: ValidationBannerInternalComponent, isStandalone: false, selector: "appfx-validation-banner-internal", inputs: { type: "type", closable: "closable", closed: "closed", items: "items" }, ngImport: i0, template: ` <clr-alert
    role="alert"
    aria-live="polite"
    [clrAlertType]="type"
    *ngIf="items?.length"
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: ValidationBannerInternalComponent, decorators: [{
            type: Component,
            args: [{
...
class ValidationBannerComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: ValidationBannerComponent, deps: [], target: i0.ɵɵFactoryTarget.Component }); }
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "21.2.23", type: ValidationBannerComponent, isStandalone: false, selector: "appfx-validation-banner", inputs: { state: "state", closable: "closable" }, ngImport: i0, template: `
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: ValidationBannerComponent, decorators: [{
            type: Component,
...
class AppfxWorkflowCoreModule {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: AppfxWorkflowCoreModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule }); }
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.2.23", ngImport: i0, type: AppfxWorkflowCoreModule, declarations: [ValidationBannerComponent,
            ValidationBannerInternalComponent,
            StepContainerComponent,
            WorkflowModelMonitorComponent,
            ErrorComponent,
            ...
            ErrorComponent,
            SpinnerComponent] }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: AppfxWorkflowCoreModule, providers: [
            {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: AppfxWorkflowCoreModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [...addonsDependencies, ...clarityDependencies, CommonModule, FormsModule, ReactiveFormsModule],
...
class RelevanceService {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: RelevanceService, deps: [], target: i0.ɵɵFactoryTarget.Injectable }); }
    static { this.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: RelevanceService }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: RelevanceService, decorators: [{
            type: Injectable
        }] });
