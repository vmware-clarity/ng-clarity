...
class AppfxWorkflowsModule {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: AppfxWorkflowsModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule }); }
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.2.23", ngImport: i0, type: AppfxWorkflowsModule, imports: [AppfxMultiPageDialogModule,
            AppfxStepperModule,
            AppfxTabsModule,
            AppfxWizardModule,
            AppfxWorkflowCoreModule], exports: [AppfxMultiPageDialogModule, AppfxStepperModule, AppfxTabsModule, AppfxWizardModule] }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: AppfxWorkflowsModule, providers: [
            {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.23", ngImport: i0, type: AppfxWorkflowsModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [
