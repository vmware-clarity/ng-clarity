...
class ClrTreeNodeLink {
    ...
    static { this.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "21.1.3", type: ClrTreeNodeLink, isStandalone: false, selector: ".clr-treenode-link", host: { properties: { "attr.tabindex": "this.tabindex" } }, ngImport: i0 }); }
}
