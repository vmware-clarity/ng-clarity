...
class WrappedFormControl {
    ...
    static { this.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "21.1.3", type: WrappedFormControl, isStandalone: true, inputs: { id: "id" }, host: { listeners: { "blur": "triggerValidation()" }, properties: { "id": "this.id", "attr.aria-invalid": "this.ariaInvalid", "attr.aria-required": "this.ariaRequired", "attr.aria-describedby": "this.ariaDescribedById" } }, ngImport: i0 }); }
}
