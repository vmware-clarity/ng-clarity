...
export class DatagridComponent<T> implements OnInit, OnDestroy, AfterViewInit, OnChanges, PreselectableComponent {
   ...
   * @default false
   */
  @Input() loadingMoreItems: boolean = false;
  ...
  onColumnOrderChange(data: ColumnOrderChanged) {
    ...
    // Only a pinned column that is actually rendered sits in the sticky container; a hidden one
    // is in neither container and does not stand in the way of the ordinary reorder.
