...
// Warning: (ae-forgotten-export) The symbol "DatagridDateFilterImpl" needs to be exported by the entry point index.d.ts
//
// @public (undocumented)
export class DatagridDateFilter<T = any> extends DatagridFilterRegistrar<T, DatagridDateFilterImpl<T>> implements CustomFilter, AfterViewInit {
    ...
    set to(to: Date);
    get value(): [Date, Date];
    set value(values: [Date, Date]);
    // (undocumented)
    static ɵcmp: i0.ɵɵComponentDeclaration<DatagridDateFilter<any>, "clr-dg-date-filter", never, { "maxPlaceholder": "clrFilterMaxPlaceholder"; "minPlaceholder": "clrFilterMinPlaceholder"; "customDateFilter": "clrDgDateFilter"; "value": "clrFilterValue"; }, { "filterValueChange": "clrFilterValueChange"; }, never, never>;
    // (undocumented)
    static ɵfac: i0.ɵɵFactoryDeclaration<DatagridDateFilter<any>, never>;
}
