...
| clr-card-header-toggle       | The chevron button rendered inside `<clr-card-header>` when the card is collapsible                                           |
| clr-card-header-icon         | The chevron icon within `.clr-card-header-toggle`                                                                             |
...
| clr-card-collapsible-region  | Wraps a collapsible card's content; toggled via `role="region"`/`aria-hidden` when `clrCardCollapsible` is set                |
| clr-card-collapsible-content | The animated inner wrapper of `.clr-card-collapsible-region` that expands/collapses                                           |
