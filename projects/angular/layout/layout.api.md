...
export class ClrNavLevel implements OnInit {
    ...
    constructor(platformId: any, cdkTrapFocus: ClrStandaloneCdkTrapFocus, responsiveNavService: ResponsiveNavigationService, elementRef: ElementRef<HTMLElement>, renderer: Renderer2, environmentInjector: EnvironmentInjector, applicationRef: ApplicationRef, injector: Injector);
    // (undocumented)
...
//
// dist/clr-angular/types/clr-angular-layout.d.ts:283:194 - (ae-forgotten-export) The symbol "i1_2" needs to be exported by the entry point clr-angular-layout.d.ts
