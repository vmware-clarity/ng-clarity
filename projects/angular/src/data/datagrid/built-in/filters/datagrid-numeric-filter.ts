    ...
    <clr-dg-filter [clrDgFilter]="registered" [(clrDgFilterOpen)]="open">
      <div class="datagrid-numeric-filter-form">
        <div class="clr-form-control">
          <label class="clr-control-label" [attr.aria-label]="fromLabelValue">{{ fromLabelValue }}</label>
          <input
            clrInput
        ...
        <div class="clr-form-control">
          <label class="clr-control-label" [attr.aria-label]="toLabelValue">{{ toLabelValue }}</label>
          <input
            clrInput
            class="datagrid-numeric-filter-input"
            #input_high
