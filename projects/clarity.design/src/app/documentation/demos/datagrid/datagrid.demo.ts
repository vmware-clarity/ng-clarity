...
import { angleIcon, ClarityIcons, infoCircleIcon, pencilIcon, plusIcon, userIcon } from '@cds/core/icon';
...
export class DatagridDemo extends ClarityDocComponent implements OnInit, OnDestroy {
  @ViewChild('demoView', { static: true }) demoView: ElementRef<HTMLDivElement> | undefined;
  ...
  apis = [
    {
      ...
      props: [
        ...
        },
        {
          ...
          type: 'ClrDatagridItemsTrackByFunction<T>',
  ...
  constructor(private route: ActivatedRoute, private router: Router, private inventory: Inventory) {
    super('datagrid');
