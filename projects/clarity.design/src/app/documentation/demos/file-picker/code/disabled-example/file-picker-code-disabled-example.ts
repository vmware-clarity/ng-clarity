...
<form clrForm clrLayout="vertical" [formGroup]="form">
  <clr-file-input-container>
    <label>Label</label>
    <input type="file" formControlName="file" [attr.disabled]="true" clrFileInput />
...
@Component({
  selector: 'app-file-picker-code-disabled-example',
  templateUrl: './file-picker-code-disabled-example.html',
  standalone: false,
})
export class FilePickerCodeDisabledExample {
