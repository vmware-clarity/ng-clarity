...
const ICONS_INSTANTIATE_EXAMPLE = `<cds-icon shape="user"></cds-icon>`;

const ADD_ICONS_EXAMPLE = `ClarityIcons.addIcons(['my-custom-icon', '<svg ... >[your SVG code goes here]</svg>']);`;

const ICONS_CUSTOMIZE_EXAMPLE = `<cds-icon shape="my-custom-shape"></cds-icon>`;

const INERT_ICONS_EXAMPLE = `<cds-icon shape="bars"></cds-icon>`;
