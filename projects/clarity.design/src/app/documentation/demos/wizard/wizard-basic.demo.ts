...
export class WizardBasic {
  @ViewChild('wizardMd', { static: true }) wizardMedium: ClrWizard | undefined;
  @ViewChild('wizardLg', { static: true }) wizardLarge: ClrWizard | undefined;
  @ViewChild('wizardXl', { static: true }) wizardExtraLarge: ClrWizard | undefined;
  @ViewChild('wizardFullScreen', { static: true }) wizardFullScreen: ClrWizard | undefined;
