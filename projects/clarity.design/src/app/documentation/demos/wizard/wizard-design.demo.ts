...
export class WizardDesignDemo {
  @ViewChild('wizard', { static: true }) protected wizard: ClrWizard | undefined;
  @ViewChild('pageOne', { static: true }) protected pageOne: ClrWizardPage | undefined;
  @ViewChild('pageTwo', { static: true }) protected pageTwo: ClrWizardPage | undefined;
  @ViewChild('pageThree', { static: true }) protected pageThree: ClrWizardPage | undefined;
  @ViewChild('pageFour', { static: true }) protected pageFour: ClrWizardPage | undefined;

  @ViewChildren(NgForm) protected forms: QueryList<NgForm> | undefined;
