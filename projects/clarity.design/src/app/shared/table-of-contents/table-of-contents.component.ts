...
@Component({
  ...
  imports: [CommonModule, RouterModule, ClrIconModule],
})
export class TableOfContentsComponent implements OnInit, OnChanges, OnDestroy {
  @Input() scrollParent: HTMLElement = document.body;
  ...
  constructor(private readonly activatedRoute: ActivatedRoute, private element: ElementRef) {}
