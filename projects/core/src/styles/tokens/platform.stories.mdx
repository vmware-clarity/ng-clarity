...
```css
@import '@clr/core/styles/module.tokens.css'; /* automatically included if using global.css */
...
```typescript
import { globalColorBlue50 } from '@clr/core/tokens/tokens.js';
...
```typescript
import * as tokens from '@clr/core/tokens/tokens.json';
```
...
```xml
<!-- Sample of @clr/core/tokens/tokens.android.xml -->
...
```swift
// Sample of @clr/core/tokens/tokens.ios.swift
