...
2.  Include @clr/core/global.min.css, @clr/core/styles/theme.dark.min.css, and clr-ui.min.css in your HTML file and add the cds-theme attribute to your body tag:

    ```
    <link rel="stylesheet" href="path/to/node_modules/@clr/core/global.min.css">
    <link rel="stylesheet" href="path/to/node_modules/@clr/core/styles/theme.dark.min.css">
