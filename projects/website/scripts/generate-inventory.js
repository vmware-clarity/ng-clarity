...
const BEGINNING = new Date(2014, 0, 1).getTime();
...
const inventoryItemsPath = path.join(
  PROJECT_ROOT,
  'src/app/documentation/demos/datagrid/inventory/inventory-items.json'
);
...
fs.writeFileSync(inventoryItemsPath, JSON.stringify(inventoryItems, undefined, 2));
