...
import { ClarityModule, SelectionType } from '@clr/angular';
...
@Component({
  selector: 'app-filters-advanced-grid-demo',
...
export class FiltersGridComponent {
  ...
  protected selectedFilterMode: FilterMode | undefined = FilterMode.AdvancedOnly;
