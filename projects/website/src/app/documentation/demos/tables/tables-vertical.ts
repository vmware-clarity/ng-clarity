  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        to align its contents to the left edge of the table data cell.
        <br />
    ...
    <tr>
      ...
      <td>
        This classname will remove borders between table rows as well as the border around the edge of
        the table.
        <br />
        Also removes the background so that the table will be transparent over the background its
        container has.
      </td>
    </tr>
    <tr>
