...
@import '../node_modules/@clr/ui/src/utils/theme.dark.clarity'; // Overwrites with dark theme // Clarity
Component SCSS @import '../node_modules/@clr/ui/src/utils/components.clarity';
`;

const UI_CUSTOM_CLARITY_DARK_THEME_SCSS_FILE = `
@import '../node_modules/@clr/ui/src/utils/theme.dark.clarity'; // Dark theme variables // Your
Application Theme File @import './theme.scss'; // Clarity Component SCSS @import
'../node_modules/@clr/ui/src/utils/components.clarity';
`;

const UI_CUSTOM_CLARITY_LIGHT_SCSS_FILE = `// Clarity Component SCSS @import '../node_modules/@clr/ui/src/utils/components.clarity';`;

const UI_CUSTOM_CLARITY_LIGHT_THEME_SCSS_FILE = `
// Your Application Theme File @import './theme.scss'; // Clarity Component SCSS @import
'../node_modules/@clr/ui/src/utils/components.clarity';
`;
