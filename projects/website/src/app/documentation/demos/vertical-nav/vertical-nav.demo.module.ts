...
import { ResponsiveBehaviourDemo } from './routes/responsive-behaviour/responsive-behaviour';
...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'responsive-behavior',
        component: ResponsiveBehaviourDemo,
        children: [
          {
            path: '',
            redirectTo: 'project-pokemon',
