...
export class SampleWorkflowService {
  ...
  private retrieveStoragePolicies(): Observable<StoragePolicy[]> {
    return of<StoragePolicy[]>([
      ...
      { id: 'policy-1', name: 'vSAN Default Storage Policy' },
      { id: 'policy-2', name: 'VVol No Requirements Policy' },
    ]).pipe(delay(10000));
  }
  ...
  private retrieveDatastores(computeResourceId: string): Observable<DatastoreGridItem[]> {
    ...
    const map: Record<string, DatastoreGridItem[]> = {
      'host-80': [
        { id: 'datastore-80', name: 'Vmfs Datastore 80', capacity: '1 TB', provisioned: '243 GB', free: '800 GB' },
        ...clusterDatastores,
      ],
      'host-81': [
        { id: 'datastore-81', name: 'Vmfs Datastore 81', capacity: '1 TB', provisioned: '243 GB', free: '800 GB' },
        ...clusterDatastores,
      ],
      'host-82': [
        { id: 'datastore-82', name: 'Vmfs Datastore 82', capacity: '1 TB', provisioned: '243 GB', free: '800 GB' },
        ...clusterDatastores,
      ],
      'host-83': [
        { id: 'datastore-83', name: 'Vmfs Datastore 83', capacity: '1 TB', provisioned: '243 GB', free: '800 GB' },
        ...clusterDatastores,
      ],
      'host-98': [
        { id: 'datastore-98', name: 'Vmfs Datastore 98', capacity: '1 TB', provisioned: '243 GB', free: '800 GB' },
      ],
      'host-103': [
        { id: 'datastore-103', name: 'Vmfs Datastore 103', capacity: '1 TB', provisioned: '243 GB', free: '800 GB' },
      ],
      'domain-c73': clusterDatastores,
    };
