...
export class ThemedImageComponent implements OnInit {
  readonly lightSrc = input<string | undefined>(undefined);
  readonly darkSrc = input<string | undefined>(undefined);
  readonly imageAlt = input<string | undefined>(undefined);
  readonly imageStyle = input<string | undefined>(undefined);
