 ...
 */
declare function hasRequiredValidator(control: AbstractControl | null | undefined): boolean;
 ...
 */
interface ClrContextSnapshotOptions {
 ...
 * simply ignore it.
 */
declare const CLR_ELEMENT_CONTEXT_PROPERTY = "clrElementContext";
/**
 ...
 */
type ClrElementContextCallback = (options: Required<ClrContextSnapshotOptions>) => Partial<ClrComponentContext> | null | undefined;
/**
 ...
 */
declare function publishElementContext(host: Element, callback: ClrElementContextCallback): () => void;
